...
// const myProfile = ["ema", 28];

// const message3 = `名前は${myProfile[0]}です。年齢は${myProfile[1]}歳です。`;
// console.log(message3);

// const [name, age] = myProfile;
// const message4 = `名前は${name[0]}です。年齢は${age[1]}歳です。`;
...
/**
 * mapやfilterを受かった配列の処理
 */
// const nameArr = ["Tanaka", "Yamada", "Ema"];
...
//   return num1 + num2 > 100 ? "more than 100" : "less than 100";
// };
